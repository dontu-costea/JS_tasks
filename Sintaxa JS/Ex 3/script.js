...
let a = prompt("Introduceti prima cifra");
let b = prompt("Introduceti a doua cifra");
let c = prompt("Introduceti a treia cifra");
let theBiggest = alert(`Cea mai mare cifra este : ${Math.max(a, b, c)}`);